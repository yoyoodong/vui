        ...
        guidelines: [
            {
                title: "对话设计原则",
                content: [
                    "设计简短、清晰、易理解的对话，避免冗长复杂的表达。",
                    "使用日常用语和口语化表达，让用户感到亲切自然。",
                    "在每次交互中明确告知用户当前状态和可执行的操作。",
                    "为用户提供多种表达同一意图的方式，增强理解准确度。"
                ]
            },
            {
                title: "语音提示设计",
                content: [
                    "语音提示应简洁明了，避免过长的回复导致用户等待。",
                    "对于复杂信息，结合语音和视觉界面协同呈现。",
                    "设计3-5种变体回复，避免重复相同的表达方式。",
                    "在提示中加入引导性内容，帮助用户了解可用功能。"
                ]
            }
        ],
        suggestions: [
            {
                title: "多轮对话设计",
                content: [
                    "设计清晰的对话流程，每次只询问一个信息点。",
                    "在多轮对话中提供上下文记忆，避免用户重复输入信息。",
                    "为用户提供明确的退出机制，随时可以结束当前任务。",
                    "设计灵活的对话路径，允许用户在对话过程中修改意图。"
                ]
            },
            {
                title: "错误处理策略",
                content: [
                    "当识别失败时，提供具体的错误原因和改进建议。",
                    "设计渐进式的帮助机制，从简单提示到详细指导。",
                    "记录常见错误模式，针对性地优化识别和理解能力。",
                    "在关键操作前进行确认，避免误操作带来的负面体验。"
                ]
            }
        ],
        keypoints: [
            {
                title: "Genie OS设计核心理念",
                content: [
                    "以用户为中心：基于用户真实需求设计功能和交互流程。",
                    "场景驱动：根据不同使用场景（家庭、办公、车载等）优化交互方式。",
                    "持续学习：系统能够从用户交互中学习，不断优化体验。",
                    "生态协同：与智能家居、内容服务等生态系统无缝协作。"
                ]
            },
            {
                title: "多模态交互设计",
                content: [
                    "语音与视觉界面协同工作，相互补充而非重复。",
                    "针对有屏设备，设计简洁直观的视觉反馈。",
                    "利用灯光、声音等非语言反馈增强交互体验。",
                    "考虑不同年龄段用户的使用习惯，提供个性化的交互模式。"
                ]
            }
        ],
        tags: ["对话管理", "多模态", "语音合成"]
